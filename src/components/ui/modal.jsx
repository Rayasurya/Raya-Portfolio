...
export const Modal = ({ dialogProps, open, onOpenChange, drawerProps, children }) => {
...
export const ModalTrigger = ({ className, children, asChild, drawerProps, popoverProps }) => {
...
export const ModalClose = ({ className, children, asChild, drawerProps, popoverProps }) => {
    const { isMobile } = useContext();
...
export const ModalContent = ({ className, children, drawerProps, popoverProps }) => {
    const { isMobile } = useContext();
...
export const ModalTitle = ({ className, children, drawerProps, popoverProps }) => {
    const { isMobile } = useContext();
...
export const ModalDescription = ({ className, children, drawerProps, popoverProps }) => {
    const { isMobile } = useContext();
