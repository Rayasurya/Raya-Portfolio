...
const Icons = {
    gitHub: (props) => (
        <svg viewBox="0 0 438.549 438.549" {...props} style={{ width: '100%', height: '100%' }}>
            <path
                fill="currentColor"
    ...
    googleDrive: (props) => (
        <svg viewBox="0 0 87.3 78" xmlns="http://www.w3.org/2000/svg" {...props} style={{ width: '100%', height: '100%' }}>
            <path
